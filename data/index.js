...
export const coursesData = [
  {
    ...
    subtitle: "June 22nd, 2020",
    image: require("../assets/background1.jpg"),
    logo: require("../assets/logo-react-navigation.png"),
    author: "Ezekiel",
    avatar: require("../assets/avatar.jpg"),
    caption: "Learn about React Navigation 5",
  },
  {
    title: "Deploying Vue App from Github to Netlify",
    subtitle: "February 25th, 2020",
    image: require("../assets/background2.jpg"),
    logo: require("../assets/logo-vue.png"),
    author: "Ezekiel",
    avatar: require("../assets/avatar.jpg"),
    caption: "Learn about deploying Vue apps to Netlify",
  },
  {
    title: "Understanding the package.json file",
    subtitle: "February 23rd, 2020",
    image: require("../assets/background3.jpg"),
    logo: require("../assets/logo-nodejs.png"),
    author: "Ezekiel",
    avatar: require("../assets/avatar.jpg"),
    caption: "Learn about the package.json file",
  },
  {
    title: "Setting up Domain with Namecheap & Netlify",
    subtitle: "January 22nd, 2020",
    image: require("../assets/background4.jpg"),
    logo: require("../assets/logo-netlify.png"),
    author: "Ezekiel",
    avatar: require("../assets/avatar.jpg"),
    caption: "Setup domain with Namecheap & Netlify",
  },
];
...
export const sectionsData = [
  ...
  },
  {
    ...
    skillImage: require("../assets/logo-nodejs.png"),
  },
  {
    title: "Nuxt",
    progress: 0.9,
    image: require("../assets/background5.jpg"),
    skillImage: require("../assets/logo-nuxt.png"),
  },
  {
    title: "GraphQL",
    progress: 0.7,
    image: require("../assets/background5.jpg"),
    skillImage: require("../assets/logo-graphql.png"),
  },
  {
    title: "MongoDB",
    progress: 0.9,
    image: require("../assets/background2.jpg"),
    skillImage: require("../assets/logo-mongodb.png"),
  },
  {
    title: "Postgres",
    progress: 0.9,
    image: require("../assets/background3.jpg"),
    skillImage: require("../assets/logo-postgres.png"),
  },
  {
    title: "Redux",
    progress: 1,
    image: require("../assets/background6.jpg"),
    skillImage: require("../assets/logo-redux.png"),
  },
  {
    title: "Docker",
    progress: 0.6,
    image: require("../assets/background1.jpg"),
    skillImage: require("../assets/logo-docker.png"),
  },
  {
    title: "PHP",
    progress: 0.8,
    image: require("../assets/background6.jpg"),
    skillImage: require("../assets/logo-php.png"),
  },
  {
    title: "Javascript",
    progress: 0.9,
    image: require("../assets/background6.jpg"),
    skillImage: require("../assets/logo-javascript.png"),
  },
];
